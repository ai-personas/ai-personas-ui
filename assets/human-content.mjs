...
const ACTIVITY_HEADLINES = Object.freeze({
  ...
  PERSONA_WORK_STATE_AUTHORED: 'Shared a persona-authored work note',
  PERSONA_INVITATION_AUTHORED: 'Invited a collaborator',
  PERSONA_INVITATION_RESPONSE_AUTHORED: 'Responded to an invitation',
  PERSONA_BIRTH_PROPOSAL_AUTHORED: 'Proposed a new persona',
  PERSONA_BIRTH_ADMITTED: 'Admitted a new persona birth',
  PERSONA_BIRTH_REFUSED: 'A persona birth proposal was refused',
  ...
  PERSONA_TURN_EFFECT_RECEIPT_RECORDED: 'Recorded the observed effect of a work step',
  ...
  TASK_COMPLETED: 'A task-completion event was recorded',
  TASK_ACCEPTED: 'A task-acceptance event was recorded',
  TASK_NOT_ACCEPTED: 'A task-rejection event was recorded',
...
const ACTION_HEADLINES = Object.freeze({
  ...
  propose_persona_birth: 'Proposed a new persona',
  record_persona_work_state: 'Authored an open work note',
  declare_artifact: 'Published artifact metadata',
...
const PURPOSE_CONTEXT = Object.freeze({
  ...
  artifact_review: 'reviewing the artifacts',
  artifact_generation: 'creating the artifacts',
  artifact_revision: 'improving the artifacts',

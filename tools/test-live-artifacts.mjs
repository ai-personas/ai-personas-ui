...
assert.match(index, /discovery\.js\?v=20260713-walkthrough-cleanup-v2/);
...
assert.match(portal, /!\['project','mission'\]\.includes\(r\.kind\)/);
assert.match(portal, /Design-history JSON is evidence/);
assert.doesNotMatch(portal, /r\.kind==='artifact'&&_isMissionDoc/);

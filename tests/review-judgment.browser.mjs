...
const plain=record({verdict:'accepted',findings:'The argument addresses the stated claim, with a clearly explained limitation.',check_receipts:{schema:'review-observations/1',capture_stage:'assessment_recording',receipts:[]}});
...
try{
 ...
 await expect(page.getByText('Citation details are incomplete or unsupported.',{exact:false})).toBeVisible();
